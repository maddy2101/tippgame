...
CREATE TABLE tx_tippgame_domain_model_tournament (
	...
	amount_rounds int(11) unsigned DEFAULT '0' NOT NULL,
	amount_teams int(11) unsigned DEFAULT '0' NOT NULL,
	players int(11) unsigned DEFAULT '0' NOT NULL,
	rounds int(11) unsigned DEFAULT '0' NOT NULL,
	winner int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_tippgame_domain_model_team'
#
CREATE TABLE tx_tippgame_domain_model_team (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
	t3ver_oid int(11) DEFAULT '0' NOT NULL,
	t3ver_id int(11) DEFAULT '0' NOT NULL,
